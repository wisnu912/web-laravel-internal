...
<div class="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6  w-full sm:max-md  md:max-w-lg  rounded-xl mx-auto mt-8 shadow-lg">
    ...
    <form action="" class="flex flex-col gap-4" method="POST"  enctype="multipart/form-data">
        <div>
            <label for="title" class="block text-sm font-medium mb-1">Title</label>
            <input type="text" name="title" id="title" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 text-black" placeholder="Enter video title">
        </div>
        <div>
            <label for="video" class="block text-sm font-medium mb-1">Video File</label>
            <input type="file" name="video" id="video" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-400 bg-white text-black">
        </div>
